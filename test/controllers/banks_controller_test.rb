...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post banks_url, params: { bank: { date: @bank.date, points: @bank.points, user_id: @bank.user_id } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { date: @bank.date, points: @bank.points, user_id: @bank.user_id } }
