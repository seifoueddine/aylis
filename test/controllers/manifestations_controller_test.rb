...
class ManifestationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manifestation" do
    assert_difference('Manifestation.count') do
      post manifestations_url, params: { manifestation: { body: @manifestation.body, title: @manifestation.title } }
    end
  ...
  test "should update manifestation" do
    patch manifestation_url(@manifestation), params: { manifestation: { body: @manifestation.body, title: @manifestation.title } }
